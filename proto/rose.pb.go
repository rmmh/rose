...
type GetattrRequest struct {
	...
	// Nonzero selects immutable snapshot metadata; cannot be combined with handle.
...
func (x *GetattrRequest) GetSnapshotId() uint64 {
	if x != nil {
		return x.SnapshotId
	}
	return 0
...
type SetattrRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Path  string                 `protobuf:"bytes,1,opt,name=path,proto3" json:"path,omitempty"`
	// When present, set the file or directory modification time (ns since epoch).
	// Absent means "leave mtime unchanged".
	Mtime         *int64 `protobuf:"varint,2,opt,name=mtime,proto3,oneof" json:"mtime,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetattrRequest) GetMtime() int64 {
...
func (x *ListDirRequest) GetSnapshotId() uint64 {
	if x != nil {
		return x.SnapshotId
	}
	return 0
...
func (x *GetMaintenanceJobRequest) Reset() {
	*x = GetMaintenanceJobRequest{}
	mi := &file_proto_rose_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMaintenanceJobRequest) Descriptor() ([]byte, []int) {
	return file_proto_rose_proto_rawDescGZIP(), []int{53}
}
...
func (x *GetMaintenanceJobResponse) Reset() {
	*x = GetMaintenanceJobResponse{}
	mi := &file_proto_rose_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetMaintenanceJobResponse) Descriptor() ([]byte, []int) {
	return file_proto_rose_proto_rawDescGZIP(), []int{54}
}
...
const file_proto_rose_proto_rawDesc = "" +
	...
	"\x06handle\x18\x02 \x01(\x03R\x06handle\x12\x1f\n" +
	...
	"\x05mtime\x18\x03 \x01(\x03R\x05mtime\"I\n" +
	"\x0eSetattrRequest\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x19\n" +
	"\x05mtime\x18\x02 \x01(\x03H\x00R\x05mtime\x88\x01\x01B\b\n" +
	"\x06_mtime\"\x11\n" +
	"\x0fSetattrResponse\"#\n" +
	...
	"\x05mtime\x18\x04 \x01(\x03R\x05mtime\"E\n" +
	...
	"\x1cMAINTENANCE_JOB_STATE_FAILED\x10\x032\x9e\x0f\n" +
	"\x04Rose\x123\n" +
	...
	"\aSetattr\x12\x17.rose.v1.SetattrRequest\x1a\x18.rose.v1.SetattrResponse\x129\n" +
...
var file_proto_rose_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
var file_proto_rose_proto_goTypes = []any{
	...
	(*SetattrRequest)(nil),            // 11: rose.v1.SetattrRequest
	(*SetattrResponse)(nil),           // 12: rose.v1.SetattrResponse
	(*UnlinkRequest)(nil),             // 13: rose.v1.UnlinkRequest
	(*UnlinkResponse)(nil),            // 14: rose.v1.UnlinkResponse
	(*RenameRequest)(nil),             // 15: rose.v1.RenameRequest
	(*RenameResponse)(nil),            // 16: rose.v1.RenameResponse
	(*DirEntry)(nil),                  // 17: rose.v1.DirEntry
	(*ListDirRequest)(nil),            // 18: rose.v1.ListDirRequest
	(*ListDirResponse)(nil),           // 19: rose.v1.ListDirResponse
	(*MkdirRequest)(nil),              // 20: rose.v1.MkdirRequest
	(*MkdirResponse)(nil),             // 21: rose.v1.MkdirResponse
	(*RmdirRequest)(nil),              // 22: rose.v1.RmdirRequest
	(*RmdirResponse)(nil),             // 23: rose.v1.RmdirResponse
	(*CreateSnapshotRequest)(nil),     // 24: rose.v1.CreateSnapshotRequest
	(*CreateSnapshotResponse)(nil),    // 25: rose.v1.CreateSnapshotResponse
	(*DeleteSnapshotRequest)(nil),     // 26: rose.v1.DeleteSnapshotRequest
	(*DeleteSnapshotResponse)(nil),    // 27: rose.v1.DeleteSnapshotResponse
	(*OpenSnapshotRequest)(nil),       // 28: rose.v1.OpenSnapshotRequest
	(*CloseRequest)(nil),              // 29: rose.v1.CloseRequest
	(*CloseResponse)(nil),             // 30: rose.v1.CloseResponse
	(*MakeVlogRequest)(nil),           // 31: rose.v1.MakeVlogRequest
	(*MakeVlogResponse)(nil),          // 32: rose.v1.MakeVlogResponse
	(*WriteVlogRequest)(nil),          // 33: rose.v1.WriteVlogRequest
	(*WriteVlogResponse)(nil),         // 34: rose.v1.WriteVlogResponse
	(*ReadVlogRequest)(nil),           // 35: rose.v1.ReadVlogRequest
	(*ReadVlogResponse)(nil),          // 36: rose.v1.ReadVlogResponse
	(*CommitVlogRequest)(nil),         // 37: rose.v1.CommitVlogRequest
	(*CommitVlogResponse)(nil),        // 38: rose.v1.CommitVlogResponse
	(*MakePlogRequest)(nil),           // 39: rose.v1.MakePlogRequest
	(*MakePlogResponse)(nil),          // 40: rose.v1.MakePlogResponse
	(*WritePlogRequest)(nil),          // 41: rose.v1.WritePlogRequest
	(*WritePlogResponse)(nil),         // 42: rose.v1.WritePlogResponse
	(*ReadPlogRequest)(nil),           // 43: rose.v1.ReadPlogRequest
	(*ReadPlogResponse)(nil),          // 44: rose.v1.ReadPlogResponse
	(*CommitPlogRequest)(nil),         // 45: rose.v1.CommitPlogRequest
	(*CommitPlogResponse)(nil),        // 46: rose.v1.CommitPlogResponse
	(*AddDiskRequest)(nil),            // 47: rose.v1.AddDiskRequest
	(*AddDiskResponse)(nil),           // 48: rose.v1.AddDiskResponse
	(*RemoveDiskRequest)(nil),         // 49: rose.v1.RemoveDiskRequest
	(*ReplaceDiskRequest)(nil),        // 50: rose.v1.ReplaceDiskRequest
	(*StartReprotectRequest)(nil),     // 51: rose.v1.StartReprotectRequest
	(*StartRebalanceRequest)(nil),     // 52: rose.v1.StartRebalanceRequest
	(*MaintenanceJobResponse)(nil),    // 53: rose.v1.MaintenanceJobResponse
	(*GetMaintenanceJobRequest)(nil),  // 54: rose.v1.GetMaintenanceJobRequest
	(*GetMaintenanceJobResponse)(nil), // 55: rose.v1.GetMaintenanceJobResponse
}
var file_proto_rose_proto_depIdxs = []int32{
	17, // 0: rose.v1.ListDirResponse.entries:type_name -> rose.v1.DirEntry
	...
	29, // 6: rose.v1.Rose.Close:input_type -> rose.v1.CloseRequest
	9,  // 7: rose.v1.Rose.Getattr:input_type -> rose.v1.GetattrRequest
	11, // 8: rose.v1.Rose.Setattr:input_type -> rose.v1.SetattrRequest
	13, // 9: rose.v1.Rose.Unlink:input_type -> rose.v1.UnlinkRequest
	15, // 10: rose.v1.Rose.Rename:input_type -> rose.v1.RenameRequest
	18, // 11: rose.v1.Rose.ListDir:input_type -> rose.v1.ListDirRequest
	20, // 12: rose.v1.Rose.Mkdir:input_type -> rose.v1.MkdirRequest
	22, // 13: rose.v1.Rose.Rmdir:input_type -> rose.v1.RmdirRequest
	24, // 14: rose.v1.Rose.CreateSnapshot:input_type -> rose.v1.CreateSnapshotRequest
	26, // 15: rose.v1.Rose.DeleteSnapshot:input_type -> rose.v1.DeleteSnapshotRequest
	28, // 16: rose.v1.Rose.OpenSnapshot:input_type -> rose.v1.OpenSnapshotRequest
	31, // 17: rose.v1.Rose.MakeVlog:input_type -> rose.v1.MakeVlogRequest
	33, // 18: rose.v1.Rose.WriteVlog:input_type -> rose.v1.WriteVlogRequest
	35, // 19: rose.v1.Rose.ReadVlog:input_type -> rose.v1.ReadVlogRequest
	37, // 20: rose.v1.Rose.CommitVlog:input_type -> rose.v1.CommitVlogRequest
	39, // 21: rose.v1.Rose.MakePlog:input_type -> rose.v1.MakePlogRequest
	41, // 22: rose.v1.Rose.WritePlog:input_type -> rose.v1.WritePlogRequest
	43, // 23: rose.v1.Rose.ReadPlog:input_type -> rose.v1.ReadPlogRequest
	45, // 24: rose.v1.Rose.CommitPlog:input_type -> rose.v1.CommitPlogRequest
	47, // 25: rose.v1.Rose.AddDisk:input_type -> rose.v1.AddDiskRequest
	49, // 26: rose.v1.Rose.RemoveDisk:input_type -> rose.v1.RemoveDiskRequest
	50, // 27: rose.v1.Rose.ReplaceDisk:input_type -> rose.v1.ReplaceDiskRequest
	51, // 28: rose.v1.Rose.StartReprotect:input_type -> rose.v1.StartReprotectRequest
	52, // 29: rose.v1.Rose.StartRebalance:input_type -> rose.v1.StartRebalanceRequest
	54, // 30: rose.v1.Rose.GetMaintenanceJob:input_type -> rose.v1.GetMaintenanceJobRequest
	2,  // 31: rose.v1.Rose.Open:output_type -> rose.v1.OpenResponse
	4,  // 32: rose.v1.Rose.Write:output_type -> rose.v1.WriteResponse
	6,  // 33: rose.v1.Rose.Read:output_type -> rose.v1.ReadResponse
	8,  // 34: rose.v1.Rose.Truncate:output_type -> rose.v1.TruncateResponse
	30, // 35: rose.v1.Rose.Close:output_type -> rose.v1.CloseResponse
	10, // 36: rose.v1.Rose.Getattr:output_type -> rose.v1.GetattrResponse
	12, // 37: rose.v1.Rose.Setattr:output_type -> rose.v1.SetattrResponse
	14, // 38: rose.v1.Rose.Unlink:output_type -> rose.v1.UnlinkResponse
	16, // 39: rose.v1.Rose.Rename:output_type -> rose.v1.RenameResponse
	19, // 40: rose.v1.Rose.ListDir:output_type -> rose.v1.ListDirResponse
	21, // 41: rose.v1.Rose.Mkdir:output_type -> rose.v1.MkdirResponse
	23, // 42: rose.v1.Rose.Rmdir:output_type -> rose.v1.RmdirResponse
	25, // 43: rose.v1.Rose.CreateSnapshot:output_type -> rose.v1.CreateSnapshotResponse
	27, // 44: rose.v1.Rose.DeleteSnapshot:output_type -> rose.v1.DeleteSnapshotResponse
	2,  // 45: rose.v1.Rose.OpenSnapshot:output_type -> rose.v1.OpenResponse
	32, // 46: rose.v1.Rose.MakeVlog:output_type -> rose.v1.MakeVlogResponse
	34, // 47: rose.v1.Rose.WriteVlog:output_type -> rose.v1.WriteVlogResponse
	36, // 48: rose.v1.Rose.ReadVlog:output_type -> rose.v1.ReadVlogResponse
	38, // 49: rose.v1.Rose.CommitVlog:output_type -> rose.v1.CommitVlogResponse
	40, // 50: rose.v1.Rose.MakePlog:output_type -> rose.v1.MakePlogResponse
	42, // 51: rose.v1.Rose.WritePlog:output_type -> rose.v1.WritePlogResponse
	44, // 52: rose.v1.Rose.ReadPlog:output_type -> rose.v1.ReadPlogResponse
	46, // 53: rose.v1.Rose.CommitPlog:output_type -> rose.v1.CommitPlogResponse
	48, // 54: rose.v1.Rose.AddDisk:output_type -> rose.v1.AddDiskResponse
	53, // 55: rose.v1.Rose.RemoveDisk:output_type -> rose.v1.MaintenanceJobResponse
	53, // 56: rose.v1.Rose.ReplaceDisk:output_type -> rose.v1.MaintenanceJobResponse
	53, // 57: rose.v1.Rose.StartReprotect:output_type -> rose.v1.MaintenanceJobResponse
	53, // 58: rose.v1.Rose.StartRebalance:output_type -> rose.v1.MaintenanceJobResponse
	55, // 59: rose.v1.Rose.GetMaintenanceJob:output_type -> rose.v1.GetMaintenanceJobResponse
...
func file_proto_rose_proto_init() {
	...
	file_proto_rose_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
