---- MODULE RoseStorage_TTrace_1782028020 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("RoseStorage_TTrace_1782028020.json", _TETrace)
...
\*
\*trace == IODeserialize("RoseStorage_TTrace_1782028020.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG RoseStorage_TTrace_1782028020 ----
CONSTANTS
    Nodes = { "d1" , "d2" , "d3" , "d4" }
    Disks = { "d1" , "d2" , "d3" , "d4" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Jun 21 01:47:50 MDT 2026