---- MODULE RoseStorage_TTrace_1782027895 ----
...
_inv ==
    ~(
        ...
        /\
        disk_state = ([d1 |-> "draining", d2 |-> "active", d3 |-> "active", d4 |-> "absent"])
        /\
        pending = ([d1 |-> {<<"o1", 0>>}, d2 |-> {}, d3 |-> {}, d4 |-> {}])
        /\
        job_disk = ([j1 |-> "d1"])
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("RoseStorage_TTrace_1782027895.json", _TETrace)
...
\*
\*trace == IODeserialize("RoseStorage_TTrace_1782027895.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1"},job_kind |-> [j1 |-> "none"],last_rpc |-> "WriteVlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1"},job_kind |-> [j1 |-> "none"],last_rpc |-> "WritePlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "draining", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "d1"],job_state |-> [j1 |-> "running"],plog_ready |-> {"d1"},job_kind |-> [j1 |-> "remove"],last_rpc |-> "RemoveDisk",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]])
    >>
----
...
---- CONFIG RoseStorage_TTrace_1782027895 ----
CONSTANTS
    Nodes = { "d1" , "d2" , "d3" , "d4" }
    Disks = { "d1" , "d2" , "d3" , "d4" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Jun 21 01:44:57 MDT 2026