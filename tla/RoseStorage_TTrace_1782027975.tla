---- MODULE RoseStorage_TTrace_1782027975 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("RoseStorage_TTrace_1782027975.json", _TETrace)
...
\*
\*trace == IODeserialize("RoseStorage_TTrace_1782027975.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "MakePlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "vlog-ready"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "WriteVlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "WritePlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {<<"o1", 0>>}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "WritePlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {<<"o1", 0>>}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "WritePlog",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {<<"o1", 0>>}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "CommitPlog",stored |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "CommitPlog",stored |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {<<"o1", 0>>}, d3 |-> {}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "CommitPlog",stored |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {<<"o1", 0>>}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "writing"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "active", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "CommitVlog",stored |-> [d1 |-> {<<"o1", 0>>}, d2 |-> {<<"o1", 0>>}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "committed"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "failed", d2 |-> "active", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "none"],job_state |-> [j1 |-> "idle"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "none"],last_rpc |-> "FailDisk",stored |-> [d1 |-> {}, d2 |-> {<<"o1", 0>>}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "committed"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> FALSE],disk_state |-> [d1 |-> "failed", d2 |-> "draining", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "d2"],job_state |-> [j1 |-> "running"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "remove"],last_rpc |-> "RemoveDisk",stored |-> [d1 |-> {}, d2 |-> {<<"o1", 0>>}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "committed"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> TRUE],disk_state |-> [d1 |-> "failed", d2 |-> "draining", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "d2"],job_state |-> [j1 |-> "running"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "remove"],last_rpc |-> "DrainCopy",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "working", d4 |-> "working"],object_state |-> [o1 |-> "committed"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]]),
    ([job_progress |-> [j1 |-> TRUE],disk_state |-> [d1 |-> "failed", d2 |-> "draining", d3 |-> "active", d4 |-> "absent"],pending |-> [d1 |-> {}, d2 |-> {}, d3 |-> {}, d4 |-> {}],job_disk |-> [j1 |-> "d2"],job_state |-> [j1 |-> "running"],plog_ready |-> {"d1", "d2", "d3"},job_kind |-> [j1 |-> "remove"],last_rpc |-> "FailNode",stored |-> [d1 |-> {}, d2 |-> {}, d3 |-> {<<"o1", 0>>}, d4 |-> {}],node_state |-> [d1 |-> "working", d2 |-> "working", d3 |-> "failed", d4 |-> "working"],object_state |-> [o1 |-> "committed"],file_state |-> [o1 |-> "buffered"],object_mode |-> [o1 |-> "DUPLICATE"]])
    >>
----
...
---- CONFIG RoseStorage_TTrace_1782027975 ----
CONSTANTS
    Nodes = { "d1" , "d2" , "d3" , "d4" }
    Disks = { "d1" , "d2" , "d3" , "d4" }
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Jun 21 01:47:06 MDT 2026